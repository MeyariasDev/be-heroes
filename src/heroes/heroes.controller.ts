...
import { HeroeService, IError, IHeroesResponse } from 'src/Services/heroe-service/heroe.service';
...
export class HeroesController {
    ...
    @Put(':id')
    async updateHeroe(@Param('id') id: string, @Body() body): Promise<IHeroesResponse | IError> {
